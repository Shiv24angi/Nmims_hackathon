    ...
    <div className="bg-white min-h-screen text-[#1C4D35] font-sans">
      <header className="fixed top-0 inset-x-0 z-[150] flex items-center px-6 pt-5 pointer-events-none">
        ...
        <div className="ml-auto flex items-center gap-3">
          <a
            href={import.meta.env.VITE_MOBILE_URL || "https://smartrasoimobileapp.vercel.app/"}
          ...
          <a
            href={import.meta.env.VITE_DASHBOARD_URL || "https://smartrasoiadmindashboard.vercel.app/"}
      ...
      <section className="py-32 px-6 bg-[#839958]">
        <div className="max-w-4xl mx-auto text-center p-12 rounded-3xl bg-[#1C4D35] border border-white/20 shadow-2xl">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <a href={import.meta.env.VITE_DASHBOARD_URL || "https://smartrasoiadmindashboard.vercel.app/"} className="px-8 py-4 bg-white hover:bg-beige text-[#1C4D35] rounded-full font-bold transition-all shadow-lg flex items-center gap-2">
              <LogIn className="w-5 h-5" /> Login to Dashboard
            </a>
            <a href={import.meta.env.VITE_MOBILE_URL || "https://smartrasoimobileapp.vercel.app/"} className="px-8 py-4 bg-transparent border-2 border-white/20 hover:bg-white/10 text-white rounded-full font-bold transition-all shadow-lg flex items-center gap-2">
              <Smartphone className="w-5 h-5" /> Connect Mobile App
            </a>
            <a href={import.meta.env.VITE_DASHBOARD_URL || "https://smartrasoiadmindashboard.vercel.app/"} className="flex items-center px-8 py-4 bg-[#93AB63] hover:bg-[#93AB63]/90 text-[#1C4D35] rounded-full font-bold transition-all shadow-lg">
              Create Account
            </a>
          </div>
        </div>
